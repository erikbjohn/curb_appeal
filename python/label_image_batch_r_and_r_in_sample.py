...
if __name__ == "__main__":
    ...
    os.chdir("/home/ebjohnson5/Dropbox/pkg.data/curb_appeal/Raw/training_to_score")
    ...
    for restart_index in restart_indices:
        ...
        with tf.Session(graph=graph) as sess:
            for file_name in files:
                ...
                outfile = '/home/ebjohnson5/Dropbox/pkg.data/curb_appeal/jrefe/r_and_r/in_sample_scores/' + file_name + '.csv'
