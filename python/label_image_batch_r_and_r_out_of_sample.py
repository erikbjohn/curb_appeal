...
if __name__ == "__main__":
    ...
    os.chdir("/home/ebjohnson5/Dropbox/pkg.data/curb_appeal/jrefe/r_and_r/out_of_sample_to_score")
    ...
    iteration = 0
    step_size = 101
    start_range = list(range(0, totalNumber-1, step_size))
    end_range = list(range(step_size, totalNumber-1, step_size))
    end_range.append(totalNumber)

    n_restarts = len(start_range)
    restart_indices = list(range(0, n_restarts, 1))
    ...
    for restart_index in restart_indices:
        ...
        with tf.Session(graph=graph) as sess:
            for file_name in files:
                ...
                outfile = '/home/ebjohnson5/Dropbox/pkg.data/curb_appeal/jrefe/r_and_r/out_of_sample_scores/' + file_name + '.csv'
